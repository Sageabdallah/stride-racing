...
**Ship criteria** (protocol step 6): directionally correct on the stated lever,
ROI bootstrap CI positive or overlapping-baseline-with-more-bets, no regression
> 5% on the other lever, CLV positive or neutral. A ticket that fails keeps its
flag OFF and is recorded here anyway — a validated negative result is a result.
